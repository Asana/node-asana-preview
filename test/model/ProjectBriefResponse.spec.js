...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectBriefResponse();
  });
  ...
  describe('ProjectBriefResponse', function() {
    it('should create an instance of ProjectBriefResponse', function() {
      // uncomment below and update the code to test ProjectBriefResponse
      //var instance = new AsanaPreview.ProjectBriefResponse();
      //expect(instance).to.be.a(AsanaPreview.ProjectBriefResponse);
    });
