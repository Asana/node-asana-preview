...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.PortfolioResponse();
  });
  ...
  describe('PortfolioResponse', function() {
    it('should create an instance of PortfolioResponse', function() {
      // uncomment below and update the code to test PortfolioResponse
      //var instance = new AsanaPreview.PortfolioResponse();
      //expect(instance).to.be.a(AsanaPreview.PortfolioResponse);
    });
