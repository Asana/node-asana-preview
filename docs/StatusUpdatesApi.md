...
> GetStatus200Response createStatusForObject(createStatusForObjectRequest, opts)
...
let createStatusForObjectRequest = new AsanaPreview.CreateStatusForObjectRequest(); // CreateStatusForObjectRequest | The status update to create.
let opts = {
...
> GetStatus200Response getStatus(statusGid, opts)
