...
export default class TasksApi {
    ...
    */
     ...
     * @param {String} error Error message, if any.
     * @param {module:model/GetTasks200Response} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * data is of type: {@link module:model/GetTasks200Response}
     */
     ...
     * @param {module:model/String} opts.resourceSubtype Filters results by the task's resource_subtype (default to 'milestone')
     * @param {String} opts.assigneeAny Comma-separated list of user identifiers
     * @param {String} opts.assigneeNot Comma-separated list of user identifiers
     * @param {String} opts.portfoliosAny Comma-separated list of portfolio IDs
     * @param {String} opts.projectsAny Comma-separated list of project IDs
     * @param {String} opts.projectsNot Comma-separated list of project IDs
     * @param {String} opts.projectsAll Comma-separated list of project IDs
     * @param {String} opts.sectionsAny Comma-separated list of section or column IDs
     * @param {String} opts.sectionsNot Comma-separated list of section or column IDs
     * @param {String} opts.sectionsAll Comma-separated list of section or column IDs
     * @param {String} opts.tagsAny Comma-separated list of tag IDs
     * @param {String} opts.tagsNot Comma-separated list of tag IDs
     * @param {String} opts.tagsAll Comma-separated list of tag IDs
     * @param {String} opts.teamsAny Comma-separated list of team IDs
     * @param {String} opts.followersNot Comma-separated list of user identifiers
     * @param {String} opts.createdByAny Comma-separated list of user identifiers
     * @param {String} opts.createdByNot Comma-separated list of user identifiers
     * @param {String} opts.assignedByAny Comma-separated list of user identifiers
     * @param {String} opts.assignedByNot Comma-separated list of user identifiers
     * @param {String} opts.likedByNot Comma-separated list of user identifiers
     * @param {String} opts.commentedOnByNot Comma-separated list of user identifiers
     * @param {Date} opts.dueOnBefore ISO 8601 date string
     * @param {Date} opts.dueOnAfter ISO 8601 date string
     * @param {Date} opts.dueOn ISO 8601 date string or `null`
     * @param {Date} opts.dueAtBefore ISO 8601 datetime string
     * @param {Date} opts.dueAtAfter ISO 8601 datetime string
     * @param {Date} opts.startOnBefore ISO 8601 date string
     * @param {Date} opts.startOnAfter ISO 8601 date string
     * @param {Date} opts.startOn ISO 8601 date string or `null`
     * @param {Date} opts.createdOnBefore ISO 8601 date string
     * @param {Date} opts.createdOnAfter ISO 8601 date string
     * @param {Date} opts.createdOn ISO 8601 date string or `null`
     * @param {Date} opts.createdAtBefore ISO 8601 datetime string
     * @param {Date} opts.createdAtAfter ISO 8601 datetime string
     * @param {Date} opts.completedOnBefore ISO 8601 date string
     * @param {Date} opts.completedOnAfter ISO 8601 date string
     * @param {Date} opts.completedOn ISO 8601 date string or `null`
     * @param {Date} opts.completedAtBefore ISO 8601 datetime string
     * @param {Date} opts.completedAtAfter ISO 8601 datetime string
     * @param {Date} opts.modifiedOnBefore ISO 8601 date string
     * @param {Date} opts.modifiedOnAfter ISO 8601 date string
     * @param {Date} opts.modifiedOn ISO 8601 date string or `null`
     * @param {Date} opts.modifiedAtBefore ISO 8601 datetime string
     * @param {Date} opts.modifiedAtAfter ISO 8601 datetime string
     * @param {Boolean} opts.isBlocking Filter to incomplete tasks with dependents
     * @param {Boolean} opts.isBlocked Filter to tasks with incomplete dependencies
     * @param {Boolean} opts.hasAttachment Filter to tasks with attachments
     * @param {Boolean} opts.completed Filter to completed tasks
     * @param {Boolean} opts.isSubtask Filter to subtasks
     * @param {module:model/String} opts.sortBy One of `due_date`, `created_at`, `completed_at`, `likes`, or `modified_at`, defaults to `modified_at` (default to 'modified_at')
     * @param {Boolean} opts.sortAscending Default `false` (default to false)
     * @param {Array.<module:model/String>} opts.optFields This endpoint returns a compact resource, which excludes some properties by default. To include those optional properties, set this query parameter to a comma-separated list of the properties you wish to include.
