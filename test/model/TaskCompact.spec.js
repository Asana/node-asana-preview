...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TaskCompact();
  });
  ...
  describe('TaskCompact', function() {
    it('should create an instance of TaskCompact', function() {
      // uncomment below and update the code to test TaskCompact
      //var instance = new AsanaPreview.TaskCompact();
      //expect(instance).to.be.a(AsanaPreview.TaskCompact);
    });
