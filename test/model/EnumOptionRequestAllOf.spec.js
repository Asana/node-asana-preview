...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.EnumOptionRequestAllOf();
  });
  ...
  describe('EnumOptionRequestAllOf', function() {
    it('should create an instance of EnumOptionRequestAllOf', function() {
      // uncomment below and update the code to test EnumOptionRequestAllOf
      //var instance = new AsanaPreview.EnumOptionRequestAllOf();
      //expect(instance).to.be.a(AsanaPreview.EnumOptionRequestAllOf);
    });
