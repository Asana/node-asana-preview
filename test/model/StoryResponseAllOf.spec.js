...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StoryResponseAllOf();
  });
  ...
  describe('StoryResponseAllOf', function() {
    it('should create an instance of StoryResponseAllOf', function() {
      // uncomment below and update the code to test StoryResponseAllOf
      //var instance = new AsanaPreview.StoryResponseAllOf();
      //expect(instance).to.be.a(AsanaPreview.StoryResponseAllOf);
    });
