...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WebhookCompactResource', function() {
      beforeEach(function() {
        instance = new AsanaPreview.WebhookCompactResource();
      });

      it('should create an instance of WebhookCompactResource', function() {
        // TODO: update the code to test WebhookCompactResource
        expect(instance).to.be.a(AsanaPreview.WebhookCompactResource);
      });
