...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.PortfolioAddItemRequest();
  });
  ...
  describe('PortfolioAddItemRequest', function() {
    it('should create an instance of PortfolioAddItemRequest', function() {
      // uncomment below and update the code to test PortfolioAddItemRequest
      //var instance = new AsanaPreview.PortfolioAddItemRequest();
      //expect(instance).to.be.a(AsanaPreview.PortfolioAddItemRequest);
    });
