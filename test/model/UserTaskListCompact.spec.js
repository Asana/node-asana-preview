...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.UserTaskListCompact();
  });
  ...
  describe('UserTaskListCompact', function() {
    it('should create an instance of UserTaskListCompact', function() {
      ...
      //var instance = new AsanaPreview.UserTaskListCompact();
      //expect(instance).to.be.a(AsanaPreview.UserTaskListCompact);
    });
