...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.UserCompact();
  });
  ...
  describe('UserCompact', function() {
    it('should create an instance of UserCompact', function() {
      // uncomment below and update the code to test UserCompact
      //var instance = new AsanaPreview.UserCompact();
      //expect(instance).to.be.a(AsanaPreview.UserCompact);
    });
