...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.UserTaskListRequest();
  });
  ...
  describe('UserTaskListRequest', function() {
    it('should create an instance of UserTaskListRequest', function() {
      // uncomment below and update the code to test UserTaskListRequest
      //var instance = new AsanaPreview.UserTaskListRequest();
      //expect(instance).to.be.a(AsanaPreview.UserTaskListRequest);
    });
