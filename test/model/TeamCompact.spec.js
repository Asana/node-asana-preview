...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TeamCompact();
  });
  ...
  describe('TeamCompact', function() {
    it('should create an instance of TeamCompact', function() {
      // uncomment below and update the code to test TeamCompact
      //var instance = new AsanaPreview.TeamCompact();
      //expect(instance).to.be.a(AsanaPreview.TeamCompact);
    });
