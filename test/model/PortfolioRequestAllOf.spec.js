...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.PortfolioRequestAllOf();
  });
  ...
  describe('PortfolioRequestAllOf', function() {
    it('should create an instance of PortfolioRequestAllOf', function() {
      // uncomment below and update the code to test PortfolioRequestAllOf
      //var instance = new AsanaPreview.PortfolioRequestAllOf();
      //expect(instance).to.be.a(AsanaPreview.PortfolioRequestAllOf);
    });
