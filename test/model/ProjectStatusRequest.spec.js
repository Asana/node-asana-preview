...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectStatusRequest();
  });
  ...
  describe('ProjectStatusRequest', function() {
    it('should create an instance of ProjectStatusRequest', function() {
      // uncomment below and update the code to test ProjectStatusRequest
      //var instance = new AsanaPreview.ProjectStatusRequest();
      //expect(instance).to.be.a(AsanaPreview.ProjectStatusRequest);
    });
