...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.OrganizationExportBase();
  });
  ...
  describe('OrganizationExportBase', function() {
    it('should create an instance of OrganizationExportBase', function() {
      // uncomment below and update the code to test OrganizationExportBase
      //var instance = new AsanaPreview.OrganizationExportBase();
      //expect(instance).to.be.a(AsanaPreview.OrganizationExportBase);
    });
