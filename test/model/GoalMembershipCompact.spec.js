...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.GoalMembershipCompact();
  });
  ...
  describe('GoalMembershipCompact', function() {
    it('should create an instance of GoalMembershipCompact', function() {
      ...
      //var instance = new AsanaPreview.GoalMembershipCompact();
      //expect(instance).to.be.a(AsanaPreview.GoalMembershipCompact);
    });
