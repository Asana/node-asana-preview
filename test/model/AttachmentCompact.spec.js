...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.AttachmentCompact();
  });
  ...
  describe('AttachmentCompact', function() {
    it('should create an instance of AttachmentCompact', function() {
      // uncomment below and update the code to test AttachmentCompact
      //var instance = new AsanaPreview.AttachmentCompact();
      //expect(instance).to.be.a(AsanaPreview.AttachmentCompact);
    });
