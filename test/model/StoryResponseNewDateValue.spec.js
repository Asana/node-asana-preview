...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StoryResponseNewDateValue();
  });
  ...
  describe('StoryResponseNewDateValue', function() {
    it('should create an instance of StoryResponseNewDateValue', function() {
      // uncomment below and update the code to test StoryResponseNewDateValue
      //var instance = new AsanaPreview.StoryResponseNewDateValue();
      //expect(instance).to.be.a(AsanaPreview.StoryResponseNewDateValue);
    });
