...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.WorkspaceMembershipCompact();
  });
  ...
  describe('WorkspaceMembershipCompact', function() {
    it('should create an instance of WorkspaceMembershipCompact', function() {
      // uncomment below and update the code to test WorkspaceMembershipCompact
      //var instance = new AsanaPreview.WorkspaceMembershipCompact();
      //expect(instance).to.be.a(AsanaPreview.WorkspaceMembershipCompact);
    });
