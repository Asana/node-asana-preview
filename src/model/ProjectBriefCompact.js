...
import ProjectBriefCompactAllOf from './ProjectBriefCompactAllOf';
...
class ProjectBriefCompact {
     ...
     * @implements module:model/ProjectBriefCompactAllOf
     */
    constructor() { 
        AsanaResource.initialize(this);ProjectBriefCompactAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ProjectBriefCompactAllOf.constructFromObject(data, obj);
...
// Implement ProjectBriefCompactAllOf interface:
/**
 * @member {Object} resource_type
 */
