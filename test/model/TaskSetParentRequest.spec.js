...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TaskSetParentRequest();
  });
  ...
  describe('TaskSetParentRequest', function() {
    it('should create an instance of TaskSetParentRequest', function() {
      // uncomment below and update the code to test TaskSetParentRequest
      //var instance = new AsanaPreview.TaskSetParentRequest();
      //expect(instance).to.be.a(AsanaPreview.TaskSetParentRequest);
    });
