...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.GoalRelationshipCompact();
  });
  ...
  describe('GoalRelationshipCompact', function() {
    it('should create an instance of GoalRelationshipCompact', function() {
      // uncomment below and update the code to test GoalRelationshipCompact
      //var instance = new AsanaPreview.GoalRelationshipCompact();
      //expect(instance).to.be.a(AsanaPreview.GoalRelationshipCompact);
    });
