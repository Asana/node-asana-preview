  ...
  describe('(package)', function() {
    describe('GoalResponseMetric', function() {
      ...
      it('should create an instance of GoalResponseMetric', function() {
        // TODO: update the code to test GoalResponseMetric
      ...
      it('should have the property can_manage (base name: "can_manage")', function() {
        // TODO: update the code to test the property can_manage
        expect(instance).to.have.property('can_manage');
        // expect(instance.can_manage).to.be(expectedValueLiteral);
      });
