...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectStatusCompact();
  });
  ...
  describe('ProjectStatusCompact', function() {
    it('should create an instance of ProjectStatusCompact', function() {
      // uncomment below and update the code to test ProjectStatusCompact
      //var instance = new AsanaPreview.ProjectStatusCompact();
      //expect(instance).to.be.a(AsanaPreview.ProjectStatusCompact);
    });
