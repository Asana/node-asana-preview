  ...
  describe('(package)', function() {
    describe('CustomFieldSettingResponseCustomField', function() {
      ...
      it('should create an instance of CustomFieldSettingResponseCustomField', function() {
        // TODO: update the code to test CustomFieldSettingResponseCustomField
      ...
      it('should have the property is_value_read_only (base name: "is_value_read_only")', function() {
        // TODO: update the code to test the property is_value_read_only
        expect(instance).to.have.property('is_value_read_only');
        // expect(instance.is_value_read_only).to.be(expectedValueLiteral);
      });
