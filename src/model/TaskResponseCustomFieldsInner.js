...
/**
 * The TaskResponseCustomFieldsInner model module.
 * @module model/TaskResponseCustomFieldsInner
 * @version 1.0.4
 */
class TaskResponseCustomFieldsInner {
    /**
     * Constructs a new <code>TaskResponseCustomFieldsInner</code>.
     ...
     * @alias module:model/TaskResponseCustomFieldsInner
     */
    constructor() { 
        
        TaskResponseCustomFieldsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TaskResponseCustomFieldsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TaskResponseCustomFieldsInner} obj Optional instance to populate.
     * @return {module:model/TaskResponseCustomFieldsInner} The populated <code>TaskResponseCustomFieldsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TaskResponseCustomFieldsInner();
            ...
            if (data.hasOwnProperty('people_value')) {
                obj['people_value'] = ApiClient.convertToType(data['people_value'], [CustomFieldResponsePeopleValueInner]);
            }
        }
        return obj;
    }
 ...
 * @member {String} gid
 */
TaskResponseCustomFieldsInner.prototype['gid'] = undefined;

/**
 * The base type of this resource.
 * @member {String} resource_type
 */
TaskResponseCustomFieldsInner.prototype['resource_type'] = undefined;

/**
 * The name of the custom field.
 * @member {String} name
 */
TaskResponseCustomFieldsInner.prototype['name'] = undefined;

/**
 * The type of the custom field. Must be one of the given values. 
 * @member {module:model/TaskResponseCustomFieldsInner.ResourceSubtypeEnum} resource_subtype
 */
TaskResponseCustomFieldsInner.prototype['resource_subtype'] = undefined;

/**
 * *Deprecated: new integrations should prefer the resource_subtype field.* The type of the custom field. Must be one of the given values. 
 * @member {module:model/TaskResponseCustomFieldsInner.TypeEnum} type
 */
TaskResponseCustomFieldsInner.prototype['type'] = undefined;
 ...
 */
TaskResponseCustomFieldsInner.prototype['enum_options'] = undefined;

/**
 * *Conditional*. Determines if the custom field is enabled or not.
 * @member {Boolean} enabled
 */
TaskResponseCustomFieldsInner.prototype['enabled'] = undefined;

/**
 * *Conditional*. This flag describes whether a custom field is a formula custom field.
 * @member {Boolean} is_formula_field
 */
TaskResponseCustomFieldsInner.prototype['is_formula_field'] = undefined;

/**
 * @member {module:model/CustomFieldBaseDateValue} date_value
 */
TaskResponseCustomFieldsInner.prototype['date_value'] = undefined;

/**
 * @member {module:model/CustomFieldBaseEnumValue} enum_value
 */
TaskResponseCustomFieldsInner.prototype['enum_value'] = undefined;

/**
 * *Conditional*. Only relevant for custom fields of type `multi_enum`. This object is the chosen values of a `multi_enum` custom field.
 * @member {Array.<module:model/CustomFieldBaseEnumOptionsInner>} multi_enum_values
 */
TaskResponseCustomFieldsInner.prototype['multi_enum_values'] = undefined;

/**
 * *Conditional*. This number is the value of a `number` custom field.
 * @member {Number} number_value
 */
TaskResponseCustomFieldsInner.prototype['number_value'] = undefined;

/**
 * *Conditional*. This string is the value of a `text` custom field.
 * @member {String} text_value
 */
TaskResponseCustomFieldsInner.prototype['text_value'] = undefined;

/**
 * A string representation for the value of the custom field. Integrations that don't require the underlying type should use this field to read values. Using this field will future-proof an app against new custom field types.
 * @member {String} display_value
 */
TaskResponseCustomFieldsInner.prototype['display_value'] = undefined;

/**
 * [Opt In](/docs/inputoutput-options). The description of the custom field.
 * @member {String} description
 */
TaskResponseCustomFieldsInner.prototype['description'] = undefined;
 ...
 */
TaskResponseCustomFieldsInner.prototype['precision'] = undefined;

/**
 * The format of this custom field.
 * @member {module:model/TaskResponseCustomFieldsInner.FormatEnum} format
 */
TaskResponseCustomFieldsInner.prototype['format'] = undefined;

/**
 * ISO 4217 currency code to format this custom field. This will be null if the `format` is not `currency`.
 * @member {String} currency_code
 */
TaskResponseCustomFieldsInner.prototype['currency_code'] = undefined;
 ...
 */
TaskResponseCustomFieldsInner.prototype['custom_label'] = undefined;
 ...
 * @member {module:model/TaskResponseCustomFieldsInner.CustomLabelPositionEnum} custom_label_position
 */
TaskResponseCustomFieldsInner.prototype['custom_label_position'] = undefined;
 ...
 */
TaskResponseCustomFieldsInner.prototype['is_global_to_workspace'] = undefined;
 ...
 */
TaskResponseCustomFieldsInner.prototype['has_notifications_enabled'] = undefined;

/**
 * *Conditional*. A unique identifier to associate this field with the template source of truth.
 * @member {module:model/TaskResponseCustomFieldsInner.AsanaCreatedFieldEnum} asana_created_field
 */
TaskResponseCustomFieldsInner.prototype['asana_created_field'] = undefined;

/**
 * *Conditional*. This flag describes whether a custom field is read only.
 * @member {Boolean} is_value_read_only
 */
TaskResponseCustomFieldsInner.prototype['is_value_read_only'] = undefined;

/**
 * @member {module:model/CustomFieldResponseCreatedBy} created_by
 */
TaskResponseCustomFieldsInner.prototype['created_by'] = undefined;
 ...
 * @member {Array.<module:model/CustomFieldResponsePeopleValueInner>} people_value
 */
TaskResponseCustomFieldsInner.prototype['people_value'] = undefined;
 ...
 * @readonly
 */
TaskResponseCustomFieldsInner['ResourceSubtypeEnum'] = {
 ...
 * @readonly
 */
TaskResponseCustomFieldsInner['TypeEnum'] = {
 ...
 * @readonly
 */
TaskResponseCustomFieldsInner['FormatEnum'] = {
 ...
 * @readonly
 */
TaskResponseCustomFieldsInner['CustomLabelPositionEnum'] = {
 ...
 * @readonly
 */
TaskResponseCustomFieldsInner['AsanaCreatedFieldEnum'] = {
...
export default TaskResponseCustomFieldsInner;
