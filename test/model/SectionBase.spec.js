...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.SectionBase();
  });
  ...
  describe('SectionBase', function() {
    it('should create an instance of SectionBase', function() {
      // uncomment below and update the code to test SectionBase
      //var instance = new AsanaPreview.SectionBase();
      //expect(instance).to.be.a(AsanaPreview.SectionBase);
    });
