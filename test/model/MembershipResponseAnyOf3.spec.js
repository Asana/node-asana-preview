...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.MembershipResponseAnyOf3();
  });
  ...
  describe('MembershipResponseAnyOf3', function() {
    it('should create an instance of MembershipResponseAnyOf3', function() {
      // uncomment below and update the code to test MembershipResponseAnyOf3
      //var instance = new AsanaPreview.MembershipResponseAnyOf3();
      //expect(instance).to.be.a(AsanaPreview.MembershipResponseAnyOf3);
    });
