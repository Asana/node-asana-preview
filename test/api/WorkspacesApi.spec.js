...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.WorkspacesApi();
  });
    ...
    describe('WorkspacesApi', function() {
      describe('addUserForWorkspace', function() {
        it('should call addUserForWorkspace successfully', function(done) {
          ...
          instance.addUserForWorkspace(body, workspace_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.UserBaseResponseData);
      ...
      describe('getWorkspace', function() {
        it('should call getWorkspace successfully', function(done) {
          ...
          instance.getWorkspace(workspace_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.WorkspaceResponseData);
      ...
      describe('getWorkspaces', function() {
        it('should call getWorkspaces successfully', function(done) {
          ...
          instance.getWorkspaces(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.WorkspaceResponseArray);
      ...
      describe('removeUserForWorkspace', function() {
        it('should call removeUserForWorkspace successfully', function(done) {
          ...
          instance.removeUserForWorkspace(body, workspace_gid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateWorkspace', function() {
        it('should call updateWorkspace successfully', function(done) {
          ...
          instance.updateWorkspace(body, workspace_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
