...
class ProjectBaseAllOf {
    /**
     * Constructs a new <code>ProjectBaseAllOf</code>.
     * @alias module:model/ProjectBaseAllOf
     */
    constructor() { 
        
        ProjectBaseAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectBaseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectBaseAllOf} obj Optional instance to populate.
     * @return {module:model/ProjectBaseAllOf} The populated <code>ProjectBaseAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectBaseAllOf();
 ...
 * @readonly
 */
ProjectBaseAllOf['DefaultViewEnum'] = {
...
export default ProjectBaseAllOf;
