...
let opts = { 
  'body': new AsanaPreview.SectionGidAddTaskBody() // SectionGidAddTaskBody | The task and optionally the insert location.
};
...
let project_gid = "1331"; // String | Globally unique identifier for the project.
let opts = { 
  'body': new AsanaPreview.SectionsInsertBody() // SectionsInsertBody | The section's move action.
};
