...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectDuplicateRequestScheduleDates();
  });
  ...
  describe('ProjectDuplicateRequestScheduleDates', function() {
    it('should create an instance of ProjectDuplicateRequestScheduleDates', function() {
      ...
      //var instance = new AsanaPreview.ProjectDuplicateRequestScheduleDates();
      //expect(instance).to.be.a(AsanaPreview.ProjectDuplicateRequestScheduleDates);
    });
