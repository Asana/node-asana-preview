...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectBriefsApi();
  });
  ...
  describe('ProjectBriefsApi', function() {
    describe('createProjectBrief', function() {
      it('should call createProjectBrief successfully', function(done) {
        //uncomment below and update the code to test createProjectBrief
        //instance.createProjectBrief(function(error) {
    ...
    describe('deleteProjectBrief', function() {
      it('should call deleteProjectBrief successfully', function(done) {
        //uncomment below and update the code to test deleteProjectBrief
        //instance.deleteProjectBrief(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getProjectBrief', function() {
      it('should call getProjectBrief successfully', function(done) {
        //uncomment below and update the code to test getProjectBrief
        //instance.getProjectBrief(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('updateProjectBrief', function() {
      it('should call updateProjectBrief successfully', function(done) {
        //uncomment below and update the code to test updateProjectBrief
        //instance.updateProjectBrief(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
