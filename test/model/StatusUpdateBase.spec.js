...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StatusUpdateBase();
  });
  ...
  describe('StatusUpdateBase', function() {
    it('should create an instance of StatusUpdateBase', function() {
      // uncomment below and update the code to test StatusUpdateBase
      //var instance = new AsanaPreview.StatusUpdateBase();
      //expect(instance).to.be.a(AsanaPreview.StatusUpdateBase);
    });
