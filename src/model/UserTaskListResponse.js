...
/**
 * The UserTaskListResponse model module.
 * @module model/UserTaskListResponse
 * @version 1.0.4
 */
class UserTaskListResponse {
    /**
     * Constructs a new <code>UserTaskListResponse</code>.
     ...
     * @alias module:model/UserTaskListResponse
     */
    constructor() { 
        
        UserTaskListResponse.initialize(this);
    }
    ...
    /**
     * Constructs a <code>UserTaskListResponse</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/UserTaskListResponse} obj Optional instance to populate.
     * @return {module:model/UserTaskListResponse} The populated <code>UserTaskListResponse</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UserTaskListResponse();
...
export default UserTaskListResponse;
