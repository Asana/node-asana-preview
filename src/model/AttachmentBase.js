...
/**
 * The AttachmentBase model module.
 * @module model/AttachmentBase
 * @version 1.0.4
 */
class AttachmentBase {
    /**
     * Constructs a new <code>AttachmentBase</code>.
     ...
     * @alias module:model/AttachmentBase
     */
    constructor() { 
        
        AttachmentBase.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AttachmentBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttachmentBase} obj Optional instance to populate.
     * @return {module:model/AttachmentBase} The populated <code>AttachmentBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachmentBase();
