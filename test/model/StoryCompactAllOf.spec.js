...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StoryCompactAllOf();
  });
  ...
  describe('StoryCompactAllOf', function() {
    it('should create an instance of StoryCompactAllOf', function() {
      // uncomment below and update the code to test StoryCompactAllOf
      //var instance = new AsanaPreview.StoryCompactAllOf();
      //expect(instance).to.be.a(AsanaPreview.StoryCompactAllOf);
    });
