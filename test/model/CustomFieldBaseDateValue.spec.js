...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.CustomFieldBaseDateValue();
  });
  ...
  describe('CustomFieldBaseDateValue', function() {
    it('should create an instance of CustomFieldBaseDateValue', function() {
      // uncomment below and update the code to test CustomFieldBaseDateValue
      //var instance = new AsanaPreview.CustomFieldBaseDateValue();
      //expect(instance).to.be.a(AsanaPreview.CustomFieldBaseDateValue);
    });
