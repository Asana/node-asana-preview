...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectRequestAllOf();
  });
  ...
  describe('ProjectRequestAllOf', function() {
    it('should create an instance of ProjectRequestAllOf', function() {
      // uncomment below and update the code to test ProjectRequestAllOf
      //var instance = new AsanaPreview.ProjectRequestAllOf();
      //expect(instance).to.be.a(AsanaPreview.ProjectRequestAllOf);
    });
