...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StoryRequest();
  });
  ...
  describe('StoryRequest', function() {
    it('should create an instance of StoryRequest', function() {
      // uncomment below and update the code to test StoryRequest
      //var instance = new AsanaPreview.StoryRequest();
      //expect(instance).to.be.a(AsanaPreview.StoryRequest);
    });
