...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TaskResponseCustomFieldsInner();
  });
  ...
  describe('TaskResponseCustomFieldsInner', function() {
    it('should create an instance of TaskResponseCustomFieldsInner', function() {
      // uncomment below and update the code to test TaskResponseCustomFieldsInner
      //var instance = new AsanaPreview.TaskResponseCustomFieldsInner();
      //expect(instance).to.be.a(AsanaPreview.TaskResponseCustomFieldsInner);
    });
