...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.EventResponseParent();
  });
  ...
  describe('EventResponseParent', function() {
    it('should create an instance of EventResponseParent', function() {
      // uncomment below and update the code to test EventResponseParent
      //var instance = new AsanaPreview.EventResponseParent();
      //expect(instance).to.be.a(AsanaPreview.EventResponseParent);
    });
