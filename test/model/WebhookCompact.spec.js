...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.WebhookCompact();
  });
  ...
  describe('WebhookCompact', function() {
    it('should create an instance of WebhookCompact', function() {
      // uncomment below and update the code to test WebhookCompact
      //var instance = new AsanaPreview.WebhookCompact();
      //expect(instance).to.be.a(AsanaPreview.WebhookCompact);
    });
