...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.CustomFieldSettingResponse();
  });
  ...
  describe('CustomFieldSettingResponse', function() {
    it('should create an instance of CustomFieldSettingResponse', function() {
      // uncomment below and update the code to test CustomFieldSettingResponse
      //var instance = new AsanaPreview.CustomFieldSettingResponse();
      //expect(instance).to.be.a(AsanaPreview.CustomFieldSettingResponse);
    });
