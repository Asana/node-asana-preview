...
/**
 * The MembershipResponseAnyOf1 model module.
 * @module model/MembershipResponseAnyOf1
 * @version 1.0.4
 */
class MembershipResponseAnyOf1 {
    /**
     * Constructs a new <code>MembershipResponseAnyOf1</code>.
     ...
     * @alias module:model/MembershipResponseAnyOf1
     */
    constructor() { 
        
        MembershipResponseAnyOf1.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MembershipResponseAnyOf1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MembershipResponseAnyOf1} obj Optional instance to populate.
     * @return {module:model/MembershipResponseAnyOf1} The populated <code>MembershipResponseAnyOf1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MembershipResponseAnyOf1();
...
export default MembershipResponseAnyOf1;
