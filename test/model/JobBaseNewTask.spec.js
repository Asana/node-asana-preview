...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.JobBaseNewTask();
  });
  ...
  describe('JobBaseNewTask', function() {
    it('should create an instance of JobBaseNewTask', function() {
      // uncomment below and update the code to test JobBaseNewTask
      //var instance = new AsanaPreview.JobBaseNewTask();
      //expect(instance).to.be.a(AsanaPreview.JobBaseNewTask);
    });
