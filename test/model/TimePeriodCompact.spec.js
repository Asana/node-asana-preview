...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TimePeriodCompact();
  });
  ...
  describe('TimePeriodCompact', function() {
    it('should create an instance of TimePeriodCompact', function() {
      // uncomment below and update the code to test TimePeriodCompact
      //var instance = new AsanaPreview.TimePeriodCompact();
      //expect(instance).to.be.a(AsanaPreview.TimePeriodCompact);
    });
