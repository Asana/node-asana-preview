...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TaskCompactAllOf();
  });
  ...
  describe('TaskCompactAllOf', function() {
    it('should create an instance of TaskCompactAllOf', function() {
      // uncomment below and update the code to test TaskCompactAllOf
      //var instance = new AsanaPreview.TaskCompactAllOf();
      //expect(instance).to.be.a(AsanaPreview.TaskCompactAllOf);
    });
