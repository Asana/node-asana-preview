...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.GoalMembershipBase();
  });
  ...
  describe('GoalMembershipBase', function() {
    it('should create an instance of GoalMembershipBase', function() {
      // uncomment below and update the code to test GoalMembershipBase
      //var instance = new AsanaPreview.GoalMembershipBase();
      //expect(instance).to.be.a(AsanaPreview.GoalMembershipBase);
    });
