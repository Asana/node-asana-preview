...
/**
 * The StoryResponseOldEnumValue model module.
 * @module model/StoryResponseOldEnumValue
 * @version 1.0.4
 */
class StoryResponseOldEnumValue {
    /**
     * Constructs a new <code>StoryResponseOldEnumValue</code>.
     ...
     * @alias module:model/StoryResponseOldEnumValue
     */
    constructor() { 
        
        StoryResponseOldEnumValue.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StoryResponseOldEnumValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoryResponseOldEnumValue} obj Optional instance to populate.
     * @return {module:model/StoryResponseOldEnumValue} The populated <code>StoryResponseOldEnumValue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoryResponseOldEnumValue();
...
export default StoryResponseOldEnumValue;
