...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectBriefRequest();
  });
  ...
  describe('ProjectBriefRequest', function() {
    it('should create an instance of ProjectBriefRequest', function() {
      // uncomment below and update the code to test ProjectBriefRequest
      //var instance = new AsanaPreview.ProjectBriefRequest();
      //expect(instance).to.be.a(AsanaPreview.ProjectBriefRequest);
    });
