...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TagResponseAllOf();
  });
  ...
  describe('TagResponseAllOf', function() {
    it('should create an instance of TagResponseAllOf', function() {
      // uncomment below and update the code to test TagResponseAllOf
      //var instance = new AsanaPreview.TagResponseAllOf();
      //expect(instance).to.be.a(AsanaPreview.TagResponseAllOf);
    });
