...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.PortfolioResponseCustomFieldsInner();
  });
  ...
  describe('PortfolioResponseCustomFieldsInner', function() {
    it('should create an instance of PortfolioResponseCustomFieldsInner', function() {
      // uncomment below and update the code to test PortfolioResponseCustomFieldsInner
      //var instance = new AsanaPreview.PortfolioResponseCustomFieldsInner();
      //expect(instance).to.be.a(AsanaPreview.PortfolioResponseCustomFieldsInner);
    });
