...
/**
 * The AttachmentResponseAllOf model module.
 * @module model/AttachmentResponseAllOf
 * @version 1.0.3
 */
class AttachmentResponseAllOf {
    /**
     * Constructs a new <code>AttachmentResponseAllOf</code>.
     * @alias module:model/AttachmentResponseAllOf
     */
    constructor() { 
        
        AttachmentResponseAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AttachmentResponseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AttachmentResponseAllOf} obj Optional instance to populate.
     * @return {module:model/AttachmentResponseAllOf} The populated <code>AttachmentResponseAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AttachmentResponseAllOf();
...
export default AttachmentResponseAllOf;
