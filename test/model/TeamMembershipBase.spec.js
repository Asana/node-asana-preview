...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TeamMembershipBase();
  });
  ...
  describe('TeamMembershipBase', function() {
    it('should create an instance of TeamMembershipBase', function() {
      // uncomment below and update the code to test TeamMembershipBase
      //var instance = new AsanaPreview.TeamMembershipBase();
      //expect(instance).to.be.a(AsanaPreview.TeamMembershipBase);
    });
