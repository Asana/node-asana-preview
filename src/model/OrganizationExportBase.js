...
/**
 * The OrganizationExportBase model module.
 * @module model/OrganizationExportBase
 * @version 1.0.4
 */
class OrganizationExportBase {
    /**
     * Constructs a new <code>OrganizationExportBase</code>.
     ...
     * @alias module:model/OrganizationExportBase
     */
    constructor() { 
        
        OrganizationExportBase.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrganizationExportBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrganizationExportBase} obj Optional instance to populate.
     * @return {module:model/OrganizationExportBase} The populated <code>OrganizationExportBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrganizationExportBase();
 ...
 * @member {module:model/OrganizationExportBase.StateEnum} state
 */
...
export default OrganizationExportBase;
