...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.WebhookRequestFiltersInner();
  });
  ...
  describe('WebhookRequestFiltersInner', function() {
    it('should create an instance of WebhookRequestFiltersInner', function() {
      ...
      //var instance = new AsanaPreview.WebhookRequestFiltersInner();
      //expect(instance).to.be.a(AsanaPreview.WebhookRequestFiltersInner);
    });
