...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectBaseWorkspace', function() {
      beforeEach(function() {
        instance = new AsanaPreview.ProjectBaseWorkspace();
      });

      it('should create an instance of ProjectBaseWorkspace', function() {
        // TODO: update the code to test ProjectBaseWorkspace
        expect(instance).to.be.a(AsanaPreview.ProjectBaseWorkspace);
      });
