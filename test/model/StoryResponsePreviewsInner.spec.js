...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StoryResponsePreviewsInner();
  });
  ...
  describe('StoryResponsePreviewsInner', function() {
    it('should create an instance of StoryResponsePreviewsInner', function() {
      // uncomment below and update the code to test StoryResponsePreviewsInner
      //var instance = new AsanaPreview.StoryResponsePreviewsInner();
      //expect(instance).to.be.a(AsanaPreview.StoryResponsePreviewsInner);
    });
