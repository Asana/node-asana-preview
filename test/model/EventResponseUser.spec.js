...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.EventResponseUser();
  });
  ...
  describe('EventResponseUser', function() {
    it('should create an instance of EventResponseUser', function() {
      // uncomment below and update the code to test EventResponseUser
      //var instance = new AsanaPreview.EventResponseUser();
      //expect(instance).to.be.a(AsanaPreview.EventResponseUser);
    });
