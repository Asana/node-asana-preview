...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.GoalRelationshipResponse();
  });
  ...
  describe('GoalRelationshipResponse', function() {
    it('should create an instance of GoalRelationshipResponse', function() {
      // uncomment below and update the code to test GoalRelationshipResponse
      //var instance = new AsanaPreview.GoalRelationshipResponse();
      //expect(instance).to.be.a(AsanaPreview.GoalRelationshipResponse);
    });
