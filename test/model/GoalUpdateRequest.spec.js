...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GoalUpdateRequest', function() {
      beforeEach(function() {
        instance = new AsanaPreview.GoalUpdateRequest();
      });

      it('should create an instance of GoalUpdateRequest', function() {
        // TODO: update the code to test GoalUpdateRequest
        expect(instance).to.be.a(AsanaPreview.GoalUpdateRequest);
      });
