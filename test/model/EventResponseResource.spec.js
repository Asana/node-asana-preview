...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.EventResponseResource();
  });
  ...
  describe('EventResponseResource', function() {
    it('should create an instance of EventResponseResource', function() {
      // uncomment below and update the code to test EventResponseResource
      //var instance = new AsanaPreview.EventResponseResource();
      //expect(instance).to.be.a(AsanaPreview.EventResponseResource);
    });
