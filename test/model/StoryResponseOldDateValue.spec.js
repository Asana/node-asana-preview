...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StoryResponseOldDateValue();
  });
  ...
  describe('StoryResponseOldDateValue', function() {
    it('should create an instance of StoryResponseOldDateValue', function() {
      // uncomment below and update the code to test StoryResponseOldDateValue
      //var instance = new AsanaPreview.StoryResponseOldDateValue();
      //expect(instance).to.be.a(AsanaPreview.StoryResponseOldDateValue);
    });
