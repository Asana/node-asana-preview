...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectTemplateCompact();
  });
  ...
  describe('ProjectTemplateCompact', function() {
    it('should create an instance of ProjectTemplateCompact', function() {
      // uncomment below and update the code to test ProjectTemplateCompact
      //var instance = new AsanaPreview.ProjectTemplateCompact();
      //expect(instance).to.be.a(AsanaPreview.ProjectTemplateCompact);
    });
