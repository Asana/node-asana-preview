...
/**
 * The CustomFieldBaseEnumOptions model module.
 * @module model/CustomFieldBaseEnumOptions
 * @version 1.0.5
 */
export class CustomFieldBaseEnumOptions {
  /**
   * Constructs a new <code>CustomFieldBaseEnumOptions</code>.
   ...
   * @alias module:model/CustomFieldBaseEnumOptions
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>CustomFieldBaseEnumOptions</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CustomFieldBaseEnumOptions} obj Optional instance to populate.
   * @return {module:model/CustomFieldBaseEnumOptions} The populated <code>CustomFieldBaseEnumOptions</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new CustomFieldBaseEnumOptions();
