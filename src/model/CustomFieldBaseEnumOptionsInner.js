...
/**
 * The CustomFieldBaseEnumOptionsInner model module.
 * @module model/CustomFieldBaseEnumOptionsInner
 * @version 1.0.4
 */
class CustomFieldBaseEnumOptionsInner {
    /**
     * Constructs a new <code>CustomFieldBaseEnumOptionsInner</code>.
     ...
     * @alias module:model/CustomFieldBaseEnumOptionsInner
     */
    constructor() { 
        
        CustomFieldBaseEnumOptionsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomFieldBaseEnumOptionsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomFieldBaseEnumOptionsInner} obj Optional instance to populate.
     * @return {module:model/CustomFieldBaseEnumOptionsInner} The populated <code>CustomFieldBaseEnumOptionsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomFieldBaseEnumOptionsInner();
 ...
 * @member {String} gid
 */
CustomFieldBaseEnumOptionsInner.prototype['gid'] = undefined;

/**
 * The base type of this resource.
 * @member {String} resource_type
 */
CustomFieldBaseEnumOptionsInner.prototype['resource_type'] = undefined;

/**
 * The name of the enum option.
 * @member {String} name
 */
CustomFieldBaseEnumOptionsInner.prototype['name'] = undefined;

/**
 * Whether or not the enum option is a selectable value for the custom field.
 * @member {Boolean} enabled
 */
CustomFieldBaseEnumOptionsInner.prototype['enabled'] = undefined;

/**
 * The color of the enum option. Defaults to ‘none’.
 * @member {String} color
 */
CustomFieldBaseEnumOptionsInner.prototype['color'] = undefined;
...
export default CustomFieldBaseEnumOptionsInner;
