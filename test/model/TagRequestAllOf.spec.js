...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TagRequestAllOf();
  });
  ...
  describe('TagRequestAllOf', function() {
    it('should create an instance of TagRequestAllOf', function() {
      // uncomment below and update the code to test TagRequestAllOf
      //var instance = new AsanaPreview.TagRequestAllOf();
      //expect(instance).to.be.a(AsanaPreview.TagRequestAllOf);
    });
