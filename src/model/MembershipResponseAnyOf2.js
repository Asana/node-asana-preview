...
/**
 * The MembershipResponseAnyOf2 model module.
 * @module model/MembershipResponseAnyOf2
 * @version 1.0.4
 */
class MembershipResponseAnyOf2 {
    /**
     * Constructs a new <code>MembershipResponseAnyOf2</code>.
     ...
     * @alias module:model/MembershipResponseAnyOf2
     */
    constructor() { 
        
        MembershipResponseAnyOf2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>MembershipResponseAnyOf2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MembershipResponseAnyOf2} obj Optional instance to populate.
     * @return {module:model/MembershipResponseAnyOf2} The populated <code>MembershipResponseAnyOf2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MembershipResponseAnyOf2();
...
export default MembershipResponseAnyOf2;
