...
class TeamBase {
    /**
     * Constructs a new <code>TeamBase</code>.
     ...
     * @alias module:model/TeamBase
     */
    constructor() { 
        
        TeamBase.initialize(this);
    }
    ...
    /**
     * Constructs a <code>TeamBase</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TeamBase} obj Optional instance to populate.
     * @return {module:model/TeamBase} The populated <code>TeamBase</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TeamBase();
