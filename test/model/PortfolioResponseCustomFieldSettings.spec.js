...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortfolioResponseCustomFieldSettings', function() {
      beforeEach(function() {
        instance = new AsanaPreview.PortfolioResponseCustomFieldSettings();
      });

      it('should create an instance of PortfolioResponseCustomFieldSettings', function() {
        // TODO: update the code to test PortfolioResponseCustomFieldSettings
        expect(instance).to.be.a(AsanaPreview.PortfolioResponseCustomFieldSettings);
      });
