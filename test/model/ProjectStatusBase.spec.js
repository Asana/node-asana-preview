...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectStatusBase();
  });
  ...
  describe('ProjectStatusBase', function() {
    it('should create an instance of ProjectStatusBase', function() {
      // uncomment below and update the code to test ProjectStatusBase
      //var instance = new AsanaPreview.ProjectStatusBase();
      //expect(instance).to.be.a(AsanaPreview.ProjectStatusBase);
    });
