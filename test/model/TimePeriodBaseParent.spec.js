...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TimePeriodBaseParent();
  });
  ...
  describe('TimePeriodBaseParent', function() {
    it('should create an instance of TimePeriodBaseParent', function() {
      // uncomment below and update the code to test TimePeriodBaseParent
      //var instance = new AsanaPreview.TimePeriodBaseParent();
      //expect(instance).to.be.a(AsanaPreview.TimePeriodBaseParent);
    });
