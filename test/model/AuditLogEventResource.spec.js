...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.AuditLogEventResource();
  });
  ...
  describe('AuditLogEventResource', function() {
    it('should create an instance of AuditLogEventResource', function() {
      // uncomment below and update the code to test AuditLogEventResource
      //var instance = new AsanaPreview.AuditLogEventResource();
      //expect(instance).to.be.a(AsanaPreview.AuditLogEventResource);
    });
