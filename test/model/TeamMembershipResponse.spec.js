...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TeamMembershipResponse();
  });
  ...
  describe('TeamMembershipResponse', function() {
    it('should create an instance of TeamMembershipResponse', function() {
      // uncomment below and update the code to test TeamMembershipResponse
      //var instance = new AsanaPreview.TeamMembershipResponse();
      //expect(instance).to.be.a(AsanaPreview.TeamMembershipResponse);
    });
