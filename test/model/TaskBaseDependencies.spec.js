...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskBaseDependencies', function() {
      beforeEach(function() {
        instance = new AsanaPreview.TaskBaseDependencies();
      });

      it('should create an instance of TaskBaseDependencies', function() {
        // TODO: update the code to test TaskBaseDependencies
        expect(instance).to.be.a(AsanaPreview.TaskBaseDependencies);
      });
