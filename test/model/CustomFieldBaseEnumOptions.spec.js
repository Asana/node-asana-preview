...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CustomFieldBaseEnumOptions', function() {
      beforeEach(function() {
        instance = new AsanaPreview.CustomFieldBaseEnumOptions();
      });

      it('should create an instance of CustomFieldBaseEnumOptions', function() {
        // TODO: update the code to test CustomFieldBaseEnumOptions
        expect(instance).to.be.a(AsanaPreview.CustomFieldBaseEnumOptions);
      });
