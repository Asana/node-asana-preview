...
export class StatusUpdateRequest {
   ...
   * @param status_type {module:model/StatusUpdateRequest.StatusTypeEnum} The type associated with the status update. This represents the current state of the object this object is on.
   * @param parent {String} The id of parent to send this status update to. This can be a project, goal or portfolio.
   */
  constructor(text, status_type, parent) {
    this.text = text;
