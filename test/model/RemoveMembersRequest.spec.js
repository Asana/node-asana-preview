...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.RemoveMembersRequest();
  });
  ...
  describe('RemoveMembersRequest', function() {
    it('should create an instance of RemoveMembersRequest', function() {
      // uncomment below and update the code to test RemoveMembersRequest
      //var instance = new AsanaPreview.RemoveMembersRequest();
      //expect(instance).to.be.a(AsanaPreview.RemoveMembersRequest);
    });
