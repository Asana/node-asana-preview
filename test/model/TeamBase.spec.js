...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TeamBase();
  });
  ...
  describe('TeamBase', function() {
    it('should create an instance of TeamBase', function() {
      // uncomment below and update the code to test TeamBase
      //var instance = new AsanaPreview.TeamBase();
      //expect(instance).to.be.a(AsanaPreview.TeamBase);
    });
