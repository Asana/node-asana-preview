...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectTemplatesApi();
  });
      ...
      describe('getProjectTemplate', function() {
        it('should call getProjectTemplate successfully', function(done) {
          ...
          instance.getProjectTemplate(project_template_gid, opts, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.ProjectTemplateResponseData);
      ...
      describe('getProjectTemplates', function() {
        it('should call getProjectTemplates successfully', function(done) {
          ...
          instance.getProjectTemplates(opts, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.ProjectTemplateResponseArray);
