...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.CreateCustomFieldRequest();
  });
  ...
  describe('CreateCustomFieldRequest', function() {
    it('should create an instance of CreateCustomFieldRequest', function() {
      ...
      //var instance = new AsanaPreview.CreateCustomFieldRequest();
      //expect(instance).to.be.a(AsanaPreview.CreateCustomFieldRequest);
    });
