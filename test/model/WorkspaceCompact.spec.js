...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.WorkspaceCompact();
  });
  ...
  describe('WorkspaceCompact', function() {
    it('should create an instance of WorkspaceCompact', function() {
      // uncomment below and update the code to test WorkspaceCompact
      //var instance = new AsanaPreview.WorkspaceCompact();
      //expect(instance).to.be.a(AsanaPreview.WorkspaceCompact);
    });
