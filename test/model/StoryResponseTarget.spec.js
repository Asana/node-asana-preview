...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StoryResponseTarget();
  });
  ...
  describe('StoryResponseTarget', function() {
    it('should create an instance of StoryResponseTarget', function() {
      // uncomment below and update the code to test StoryResponseTarget
      //var instance = new AsanaPreview.StoryResponseTarget();
      //expect(instance).to.be.a(AsanaPreview.StoryResponseTarget);
    });
