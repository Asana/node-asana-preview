...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StatusUpdateCompact();
  });
  ...
  describe('StatusUpdateCompact', function() {
    it('should create an instance of StatusUpdateCompact', function() {
      // uncomment below and update the code to test StatusUpdateCompact
      //var instance = new AsanaPreview.StatusUpdateCompact();
      //expect(instance).to.be.a(AsanaPreview.StatusUpdateCompact);
    });
