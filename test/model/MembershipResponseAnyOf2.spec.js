...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.MembershipResponseAnyOf2();
  });
  ...
  describe('MembershipResponseAnyOf2', function() {
    it('should create an instance of MembershipResponseAnyOf2', function() {
      // uncomment below and update the code to test MembershipResponseAnyOf2
      //var instance = new AsanaPreview.MembershipResponseAnyOf2();
      //expect(instance).to.be.a(AsanaPreview.MembershipResponseAnyOf2);
    });
