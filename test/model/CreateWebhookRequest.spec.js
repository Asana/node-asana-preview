...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.CreateWebhookRequest();
  });
  ...
  describe('CreateWebhookRequest', function() {
    it('should create an instance of CreateWebhookRequest', function() {
      ...
      //var instance = new AsanaPreview.CreateWebhookRequest();
      //expect(instance).to.be.a(AsanaPreview.CreateWebhookRequest);
    });
