...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectsApi();
  });
    ...
    describe('ProjectsApi', function() {
      describe('addCustomFieldSettingForProject', function() {
        it('should call addCustomFieldSettingForProject successfully', function(done) {
          ...
          instance.addCustomFieldSettingForProject(body, project_gid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.CustomFieldSettingResponseData);
      ...
      describe('addFollowersForProject', function() {
        it('should call addFollowersForProject successfully', function(done) {
          ...
          instance.addFollowersForProject(body, project_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.ProjectResponseData);
      ...
      describe('addMembersForProject', function() {
        it('should call addMembersForProject successfully', function(done) {
          ...
          instance.addMembersForProject(body, project_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('createProject', function() {
        it('should call createProject successfully', function(done) {
          ...
          instance.createProject(body, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('createProjectForTeam', function() {
        it('should call createProjectForTeam successfully', function(done) {
          ...
          instance.createProjectForTeam(body, team_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('createProjectForWorkspace', function() {
        it('should call createProjectForWorkspace successfully', function(done) {
          ...
          instance.createProjectForWorkspace(body, workspace_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('deleteProject', function() {
        it('should call deleteProject successfully', function(done) {
          ...
          instance.deleteProject(project_gid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.EmptyResponseData);
      ...
      describe('duplicateProject', function() {
        it('should call duplicateProject successfully', function(done) {
          ...
          instance.duplicateProject(project_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.JobResponseData);
      ...
      describe('getProject', function() {
        it('should call getProject successfully', function(done) {
          ...
          instance.getProject(project_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getProjects', function() {
        it('should call getProjects successfully', function(done) {
          ...
          instance.getProjects(opts, function(error, data, response) {
            ...
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.ProjectResponseArray);
      ...
      describe('getProjectsForTask', function() {
        it('should call getProjectsForTask successfully', function(done) {
          ...
          instance.getProjectsForTask(task_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getProjectsForTeam', function() {
        it('should call getProjectsForTeam successfully', function(done) {
          ...
          instance.getProjectsForTeam(team_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getProjectsForWorkspace', function() {
        it('should call getProjectsForWorkspace successfully', function(done) {
          ...
          instance.getProjectsForWorkspace(workspace_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getTaskCountsForProject', function() {
        it('should call getTaskCountsForProject successfully', function(done) {
          ...
          instance.getTaskCountsForProject(project_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.TaskCountResponseData);
      ...
      describe('projectSaveAsTemplate', function() {
        it('should call projectSaveAsTemplate successfully', function(done) {
          ...
          instance.projectSaveAsTemplate(body, project_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('removeCustomFieldSettingForProject', function() {
        it('should call removeCustomFieldSettingForProject successfully', function(done) {
          ...
          instance.removeCustomFieldSettingForProject(body, project_gid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('removeFollowersForProject', function() {
        it('should call removeFollowersForProject successfully', function(done) {
          ...
          instance.removeFollowersForProject(body, project_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('removeMembersForProject', function() {
        it('should call removeMembersForProject successfully', function(done) {
          ...
          instance.removeMembersForProject(body, project_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('updateProject', function() {
        it('should call updateProject successfully', function(done) {
          ...
          instance.updateProject(body, project_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
