...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.CreateProjectRequest();
  });
  ...
  describe('CreateProjectRequest', function() {
    it('should create an instance of CreateProjectRequest', function() {
      ...
      //var instance = new AsanaPreview.CreateProjectRequest();
      //expect(instance).to.be.a(AsanaPreview.CreateProjectRequest);
    });
