...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.AsanaResource();
  });
  ...
  describe('AsanaResource', function() {
    it('should create an instance of AsanaResource', function() {
      // uncomment below and update the code to test AsanaResource
      //var instance = new AsanaPreview.AsanaResource();
      //expect(instance).to.be.a(AsanaPreview.AsanaResource);
    });
