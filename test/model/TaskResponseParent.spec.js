...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TaskResponseParent();
  });
  ...
  describe('TaskResponseParent', function() {
    it('should create an instance of TaskResponseParent', function() {
      // uncomment below and update the code to test TaskResponseParent
      //var instance = new AsanaPreview.TaskResponseParent();
      //expect(instance).to.be.a(AsanaPreview.TaskResponseParent);
    });
