...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.OrganizationExportCompact();
  });
  ...
  describe('OrganizationExportCompact', function() {
    it('should create an instance of OrganizationExportCompact', function() {
      // uncomment below and update the code to test OrganizationExportCompact
      //var instance = new AsanaPreview.OrganizationExportCompact();
      //expect(instance).to.be.a(AsanaPreview.OrganizationExportCompact);
    });
