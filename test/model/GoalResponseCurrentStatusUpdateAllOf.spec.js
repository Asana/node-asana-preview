...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.GoalResponseCurrentStatusUpdateAllOf();
  });
  ...
  describe('GoalResponseCurrentStatusUpdateAllOf', function() {
    it('should create an instance of GoalResponseCurrentStatusUpdateAllOf', function() {
      // uncomment below and update the code to test GoalResponseCurrentStatusUpdateAllOf
      //var instance = new AsanaPreview.GoalResponseCurrentStatusUpdateAllOf();
      //expect(instance).to.be.a(AsanaPreview.GoalResponseCurrentStatusUpdateAllOf);
    });
