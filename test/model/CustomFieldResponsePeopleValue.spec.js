...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CustomFieldResponsePeopleValue', function() {
      beforeEach(function() {
        instance = new AsanaPreview.CustomFieldResponsePeopleValue();
      });

      it('should create an instance of CustomFieldResponsePeopleValue', function() {
        // TODO: update the code to test CustomFieldResponsePeopleValue
        expect(instance).to.be.a(AsanaPreview.CustomFieldResponsePeopleValue);
      });
