...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.RemoveFollowersRequest();
  });
  ...
  describe('RemoveFollowersRequest', function() {
    it('should create an instance of RemoveFollowersRequest', function() {
      // uncomment below and update the code to test RemoveFollowersRequest
      //var instance = new AsanaPreview.RemoveFollowersRequest();
      //expect(instance).to.be.a(AsanaPreview.RemoveFollowersRequest);
    });
