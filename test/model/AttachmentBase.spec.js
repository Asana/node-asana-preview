...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.AttachmentBase();
  });
  ...
  describe('AttachmentBase', function() {
    it('should create an instance of AttachmentBase', function() {
      // uncomment below and update the code to test AttachmentBase
      //var instance = new AsanaPreview.AttachmentBase();
      //expect(instance).to.be.a(AsanaPreview.AttachmentBase);
    });
