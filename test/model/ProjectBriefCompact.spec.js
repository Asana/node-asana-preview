...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectBriefCompact();
  });
  ...
  describe('ProjectBriefCompact', function() {
    it('should create an instance of ProjectBriefCompact', function() {
      // uncomment below and update the code to test ProjectBriefCompact
      //var instance = new AsanaPreview.ProjectBriefCompact();
      //expect(instance).to.be.a(AsanaPreview.ProjectBriefCompact);
    });
