...
/**
 * The StoryBaseAllOf model module.
 * @module model/StoryBaseAllOf
 * @version 1.0.3
 */
class StoryBaseAllOf {
    /**
     * Constructs a new <code>StoryBaseAllOf</code>.
     * A story represents an activity associated with an object in the Asana system.
     * @alias module:model/StoryBaseAllOf
     */
    constructor() { 
        
        StoryBaseAllOf.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StoryBaseAllOf</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoryBaseAllOf} obj Optional instance to populate.
     * @return {module:model/StoryBaseAllOf} The populated <code>StoryBaseAllOf</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoryBaseAllOf();
 ...
 * @readonly
 */
StoryBaseAllOf['StickerNameEnum'] = {
