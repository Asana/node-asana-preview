 ...
 * @version 1.0.4
 */
class CustomFieldBaseEnumValue {
    /**
     * Constructs a new <code>CustomFieldBaseEnumValue</code>.
     ...
     * @alias module:model/CustomFieldBaseEnumValue
     */
    constructor() { 
        
        CustomFieldBaseEnumValue.initialize(this);
    }
    ...
    /**
     * Constructs a <code>CustomFieldBaseEnumValue</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/CustomFieldBaseEnumValue} obj Optional instance to populate.
     * @return {module:model/CustomFieldBaseEnumValue} The populated <code>CustomFieldBaseEnumValue</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CustomFieldBaseEnumValue();
...
export default CustomFieldBaseEnumValue;
