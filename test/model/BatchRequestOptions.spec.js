...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BatchRequestOptions', function() {
      beforeEach(function() {
        instance = new AsanaPreview.BatchRequestOptions();
      });

      it('should create an instance of BatchRequestOptions', function() {
        // TODO: update the code to test BatchRequestOptions
        expect(instance).to.be.a(AsanaPreview.BatchRequestOptions);
      });
