...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.UserTaskListResponse();
  });
  ...
  describe('UserTaskListResponse', function() {
    it('should create an instance of UserTaskListResponse', function() {
      // uncomment below and update the code to test UserTaskListResponse
      //var instance = new AsanaPreview.UserTaskListResponse();
      //expect(instance).to.be.a(AsanaPreview.UserTaskListResponse);
    });
