...
class StatusUpdateResponseParent {
    /**
     * Constructs a new <code>StatusUpdateResponseParent</code>.
     ...
     * @alias module:model/StatusUpdateResponseParent
     */
    constructor() { 
        
        StatusUpdateResponseParent.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StatusUpdateResponseParent</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StatusUpdateResponseParent} obj Optional instance to populate.
     * @return {module:model/StatusUpdateResponseParent} The populated <code>StatusUpdateResponseParent</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatusUpdateResponseParent();
...
export default StatusUpdateResponseParent;
