...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.WorkspaceMembershipBase();
  });
  ...
  describe('WorkspaceMembershipBase', function() {
    it('should create an instance of WorkspaceMembershipBase', function() {
      // uncomment below and update the code to test WorkspaceMembershipBase
      //var instance = new AsanaPreview.WorkspaceMembershipBase();
      //expect(instance).to.be.a(AsanaPreview.WorkspaceMembershipBase);
    });
