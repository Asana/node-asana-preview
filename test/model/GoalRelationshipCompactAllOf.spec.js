...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.GoalRelationshipCompactAllOf();
  });
  ...
  describe('GoalRelationshipCompactAllOf', function() {
    it('should create an instance of GoalRelationshipCompactAllOf', function() {
      // uncomment below and update the code to test GoalRelationshipCompactAllOf
      //var instance = new AsanaPreview.GoalRelationshipCompactAllOf();
      //expect(instance).to.be.a(AsanaPreview.GoalRelationshipCompactAllOf);
    });
