...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.GoalRelationshipBase();
  });
  ...
  describe('GoalRelationshipBase', function() {
    it('should create an instance of GoalRelationshipBase', function() {
      // uncomment below and update the code to test GoalRelationshipBase
      //var instance = new AsanaPreview.GoalRelationshipBase();
      //expect(instance).to.be.a(AsanaPreview.GoalRelationshipBase);
    });
