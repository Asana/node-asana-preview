...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskBaseSection', function() {
      beforeEach(function() {
        instance = new AsanaPreview.TaskBaseSection();
      });

      it('should create an instance of TaskBaseSection', function() {
        // TODO: update the code to test TaskBaseSection
        expect(instance).to.be.a(AsanaPreview.TaskBaseSection);
      });
