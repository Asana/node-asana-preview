...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskResponseTags', function() {
      beforeEach(function() {
        instance = new AsanaPreview.TaskResponseTags();
      });

      it('should create an instance of TaskResponseTags', function() {
        // TODO: update the code to test TaskResponseTags
        expect(instance).to.be.a(AsanaPreview.TaskResponseTags);
      });
