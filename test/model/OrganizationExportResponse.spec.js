...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.OrganizationExportResponse();
  });
  ...
  describe('OrganizationExportResponse', function() {
    it('should create an instance of OrganizationExportResponse', function() {
      // uncomment below and update the code to test OrganizationExportResponse
      //var instance = new AsanaPreview.OrganizationExportResponse();
      //expect(instance).to.be.a(AsanaPreview.OrganizationExportResponse);
    });
