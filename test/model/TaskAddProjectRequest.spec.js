...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TaskAddProjectRequest();
  });
  ...
  describe('TaskAddProjectRequest', function() {
    it('should create an instance of TaskAddProjectRequest', function() {
      ...
      //var instance = new AsanaPreview.TaskAddProjectRequest();
      //expect(instance).to.be.a(AsanaPreview.TaskAddProjectRequest);
    });
