  ...
  describe('(package)', function() {
    describe('UserResponse', function() {
      ...
      it('should have the property workspaces (base name: "workspaces")', function() {
        // TODO: update the code to test the property workspaces
        expect(instance).to.have.property('workspaces');
        // expect(instance.workspaces).to.be(expectedValueLiteral);
      });
