...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StoryBase();
  });
  ...
  describe('StoryBase', function() {
    it('should create an instance of StoryBase', function() {
      // uncomment below and update the code to test StoryBase
      //var instance = new AsanaPreview.StoryBase();
      //expect(instance).to.be.a(AsanaPreview.StoryBase);
    });
