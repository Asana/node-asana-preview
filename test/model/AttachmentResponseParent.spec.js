...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.AttachmentResponseParent();
  });
  ...
  describe('AttachmentResponseParent', function() {
    it('should create an instance of AttachmentResponseParent', function() {
      // uncomment below and update the code to test AttachmentResponseParent
      //var instance = new AsanaPreview.AttachmentResponseParent();
      //expect(instance).to.be.a(AsanaPreview.AttachmentResponseParent);
    });
