...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StatusUpdateBaseAllOf();
  });
  ...
  describe('StatusUpdateBaseAllOf', function() {
    it('should create an instance of StatusUpdateBaseAllOf', function() {
      // uncomment below and update the code to test StatusUpdateBaseAllOf
      //var instance = new AsanaPreview.StatusUpdateBaseAllOf();
      //expect(instance).to.be.a(AsanaPreview.StatusUpdateBaseAllOf);
    });
