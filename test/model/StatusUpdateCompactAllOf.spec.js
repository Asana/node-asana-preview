...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StatusUpdateCompactAllOf();
  });
  ...
  describe('StatusUpdateCompactAllOf', function() {
    it('should create an instance of StatusUpdateCompactAllOf', function() {
      // uncomment below and update the code to test StatusUpdateCompactAllOf
      //var instance = new AsanaPreview.StatusUpdateCompactAllOf();
      //expect(instance).to.be.a(AsanaPreview.StatusUpdateCompactAllOf);
    });
