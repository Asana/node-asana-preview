...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ErrorResponseErrors', function() {
      beforeEach(function() {
        instance = new AsanaPreview.ErrorResponseErrors();
      });

      it('should create an instance of ErrorResponseErrors', function() {
        // TODO: update the code to test ErrorResponseErrors
        expect(instance).to.be.a(AsanaPreview.ErrorResponseErrors);
      });
