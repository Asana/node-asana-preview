...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.PortfolioResponseAllOf();
  });
  ...
  describe('PortfolioResponseAllOf', function() {
    it('should create an instance of PortfolioResponseAllOf', function() {
      // uncomment below and update the code to test PortfolioResponseAllOf
      //var instance = new AsanaPreview.PortfolioResponseAllOf();
      //expect(instance).to.be.a(AsanaPreview.PortfolioResponseAllOf);
    });
    ...
    it('should have the property projectTemplates (base name: "project_templates")', function() {
      // uncomment below and update the code to test the property projectTemplates
      //var instance = new AsanaPreview.PortfolioResponseAllOf();
      //expect(instance).to.be();
    });
