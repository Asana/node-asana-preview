...
/**
 * The WebhookRequestFilters model module.
 * @module model/WebhookRequestFilters
 * @version 1.0.6
 */
export class WebhookRequestFilters {
  /**
   * Constructs a new <code>WebhookRequestFilters</code>.
   ...
   * @alias module:model/WebhookRequestFilters
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>WebhookRequestFilters</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WebhookRequestFilters} obj Optional instance to populate.
   * @return {module:model/WebhookRequestFilters} The populated <code>WebhookRequestFilters</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new WebhookRequestFilters();
