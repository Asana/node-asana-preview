...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectCompact();
  });
  ...
  describe('ProjectCompact', function() {
    it('should create an instance of ProjectCompact', function() {
      // uncomment below and update the code to test ProjectCompact
      //var instance = new AsanaPreview.ProjectCompact();
      //expect(instance).to.be.a(AsanaPreview.ProjectCompact);
    });
