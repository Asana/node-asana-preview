...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectBaseCurrentStatusUpdate();
  });
  ...
  describe('ProjectBaseCurrentStatusUpdate', function() {
    it('should create an instance of ProjectBaseCurrentStatusUpdate', function() {
      // uncomment below and update the code to test ProjectBaseCurrentStatusUpdate
      //var instance = new AsanaPreview.ProjectBaseCurrentStatusUpdate();
      //expect(instance).to.be.a(AsanaPreview.ProjectBaseCurrentStatusUpdate);
    });
