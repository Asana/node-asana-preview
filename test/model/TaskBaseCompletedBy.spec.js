...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskBaseCompletedBy', function() {
      beforeEach(function() {
        instance = new AsanaPreview.TaskBaseCompletedBy();
      });

      it('should create an instance of TaskBaseCompletedBy', function() {
        // TODO: update the code to test TaskBaseCompletedBy
        expect(instance).to.be.a(AsanaPreview.TaskBaseCompletedBy);
      });
