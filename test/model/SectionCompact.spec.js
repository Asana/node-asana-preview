...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.SectionCompact();
  });
  ...
  describe('SectionCompact', function() {
    it('should create an instance of SectionCompact', function() {
      // uncomment below and update the code to test SectionCompact
      //var instance = new AsanaPreview.SectionCompact();
      //expect(instance).to.be.a(AsanaPreview.SectionCompact);
    });
