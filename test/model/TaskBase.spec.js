...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TaskBase();
  });
  ...
  describe('TaskBase', function() {
    it('should create an instance of TaskBase', function() {
      // uncomment below and update the code to test TaskBase
      //var instance = new AsanaPreview.TaskBase();
      //expect(instance).to.be.a(AsanaPreview.TaskBase);
    });
