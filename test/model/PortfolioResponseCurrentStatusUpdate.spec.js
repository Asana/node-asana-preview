...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.PortfolioResponseCurrentStatusUpdate();
  });
  ...
  describe('PortfolioResponseCurrentStatusUpdate', function() {
    it('should create an instance of PortfolioResponseCurrentStatusUpdate', function() {
      // uncomment below and update the code to test PortfolioResponseCurrentStatusUpdate
      //var instance = new AsanaPreview.PortfolioResponseCurrentStatusUpdate();
      //expect(instance).to.be.a(AsanaPreview.PortfolioResponseCurrentStatusUpdate);
    });
