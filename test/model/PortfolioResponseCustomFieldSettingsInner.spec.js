...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.PortfolioResponseCustomFieldSettingsInner();
  });
  ...
  describe('PortfolioResponseCustomFieldSettingsInner', function() {
    it('should create an instance of PortfolioResponseCustomFieldSettingsInner', function() {
      // uncomment below and update the code to test PortfolioResponseCustomFieldSettingsInner
      //var instance = new AsanaPreview.PortfolioResponseCustomFieldSettingsInner();
      //expect(instance).to.be.a(AsanaPreview.PortfolioResponseCustomFieldSettingsInner);
    });
