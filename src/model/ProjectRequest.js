...
import ProjectRequestAllOf from './ProjectRequestAllOf';
...
class ProjectRequest {
     ...
     * @implements module:model/ProjectRequestAllOf
     */
    constructor() { 
        ProjectBase.initialize(this);ProjectRequestAllOf.initialize(this);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ProjectRequestAllOf.constructFromObject(data, obj);
...
// Implement ProjectRequestAllOf interface:
/**
 * An object where each key is a Custom Field GID and each value is an enum GID, string, number, or object.
 * @member {Object.<String, String>} custom_fields
 */
