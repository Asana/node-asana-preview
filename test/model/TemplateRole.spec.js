...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TemplateRole();
  });
  ...
  describe('TemplateRole', function() {
    it('should create an instance of TemplateRole', function() {
      // uncomment below and update the code to test TemplateRole
      //var instance = new AsanaPreview.TemplateRole();
      //expect(instance).to.be.a(AsanaPreview.TemplateRole);
    });
