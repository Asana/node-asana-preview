...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskResponseCustomFields', function() {
      beforeEach(function() {
        instance = new AsanaPreview.TaskResponseCustomFields();
      });

      it('should create an instance of TaskResponseCustomFields', function() {
        // TODO: update the code to test TaskResponseCustomFields
        expect(instance).to.be.a(AsanaPreview.TaskResponseCustomFields);
      });
