...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectTemplateBaseTeam', function() {
      beforeEach(function() {
        instance = new AsanaPreview.ProjectTemplateBaseTeam();
      });

      it('should create an instance of ProjectTemplateBaseTeam', function() {
        // TODO: update the code to test ProjectTemplateBaseTeam
        expect(instance).to.be.a(AsanaPreview.ProjectTemplateBaseTeam);
      });
