...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.MessageBase();
  });
  ...
  describe('MessageBase', function() {
    it('should create an instance of MessageBase', function() {
      // uncomment below and update the code to test MessageBase
      //var instance = new AsanaPreview.MessageBase();
      //expect(instance).to.be.a(AsanaPreview.MessageBase);
    });
