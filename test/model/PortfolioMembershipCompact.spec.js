...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.PortfolioMembershipCompact();
  });
  ...
  describe('PortfolioMembershipCompact', function() {
    it('should create an instance of PortfolioMembershipCompact', function() {
      // uncomment below and update the code to test PortfolioMembershipCompact
      //var instance = new AsanaPreview.PortfolioMembershipCompact();
      //expect(instance).to.be.a(AsanaPreview.PortfolioMembershipCompact);
    });
