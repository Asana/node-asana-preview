...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.CreateProjectFromAsanaTemplateRequest();
  });
  ...
  describe('CreateProjectFromAsanaTemplateRequest', function() {
    it('should create an instance of CreateProjectFromAsanaTemplateRequest', function() {
      // uncomment below and update the code to test CreateProjectFromAsanaTemplateRequest
      //var instance = new AsanaPreview.CreateProjectFromAsanaTemplateRequest();
      //expect(instance).to.be.a(AsanaPreview.CreateProjectFromAsanaTemplateRequest);
    });
