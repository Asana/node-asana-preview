...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StatusUpdateRequest();
  });
  ...
  describe('StatusUpdateRequest', function() {
    it('should create an instance of StatusUpdateRequest', function() {
      // uncomment below and update the code to test StatusUpdateRequest
      //var instance = new AsanaPreview.StatusUpdateRequest();
      //expect(instance).to.be.a(AsanaPreview.StatusUpdateRequest);
    });
