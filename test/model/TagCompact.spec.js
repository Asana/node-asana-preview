...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.TagCompact();
  });
  ...
  describe('TagCompact', function() {
    it('should create an instance of TagCompact', function() {
      // uncomment below and update the code to test TagCompact
      //var instance = new AsanaPreview.TagCompact();
      //expect(instance).to.be.a(AsanaPreview.TagCompact);
    });
