...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.StoryResponseTask();
  });
  ...
  describe('StoryResponseTask', function() {
    it('should create an instance of StoryResponseTask', function() {
      // uncomment below and update the code to test StoryResponseTask
      //var instance = new AsanaPreview.StoryResponseTask();
      //expect(instance).to.be.a(AsanaPreview.StoryResponseTask);
    });
