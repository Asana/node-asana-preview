...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.MembershipResponse();
  });
  ...
  describe('MembershipResponse', function() {
    it('should create an instance of MembershipResponse', function() {
      // uncomment below and update the code to test MembershipResponse
      //var instance = new AsanaPreview.MembershipResponse();
      //expect(instance).to.be.a(AsanaPreview.MembershipResponse);
    });
    ...
    it('should have the property writeAccess (base name: "write_access")', function() {
      // uncomment below and update the code to test the property writeAccess
      //var instance = new AsanaPreview.MembershipResponse();
      //expect(instance).to.be();
    });
