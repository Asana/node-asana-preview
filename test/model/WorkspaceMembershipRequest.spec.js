...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.WorkspaceMembershipRequest();
  });
  ...
  describe('WorkspaceMembershipRequest', function() {
    it('should create an instance of WorkspaceMembershipRequest', function() {
      // uncomment below and update the code to test WorkspaceMembershipRequest
      //var instance = new AsanaPreview.WorkspaceMembershipRequest();
      //expect(instance).to.be.a(AsanaPreview.WorkspaceMembershipRequest);
    });
