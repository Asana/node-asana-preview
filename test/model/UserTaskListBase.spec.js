...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.UserTaskListBase();
  });
  ...
  describe('UserTaskListBase', function() {
    it('should create an instance of UserTaskListBase', function() {
      // uncomment below and update the code to test UserTaskListBase
      //var instance = new AsanaPreview.UserTaskListBase();
      //expect(instance).to.be.a(AsanaPreview.UserTaskListBase);
    });
