...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.AsanaNamedResource();
  });
  ...
  describe('AsanaNamedResource', function() {
    it('should create an instance of AsanaNamedResource', function() {
      // uncomment below and update the code to test AsanaNamedResource
      //var instance = new AsanaPreview.AsanaNamedResource();
      //expect(instance).to.be.a(AsanaPreview.AsanaNamedResource);
    });
