...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.GoalAddSubgoalRequest();
  });
  ...
  describe('GoalAddSubgoalRequest', function() {
    it('should create an instance of GoalAddSubgoalRequest', function() {
      ...
      //var instance = new AsanaPreview.GoalAddSubgoalRequest();
      //expect(instance).to.be.a(AsanaPreview.GoalAddSubgoalRequest);
    });
