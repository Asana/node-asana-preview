...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.MembershipsApi();
  });
    ...
    describe('MembershipsApi', function() {
      describe('createMembership', function() {
        it('should call createMembership successfully', function(done) {
          ...
          instance.createMembership(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.MembershipResponseData);
      ...
      describe('deleteMembership', function() {
        it('should call deleteMembership successfully', function(done) {
          ...
          instance.deleteMembership(membership_gid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getMemberships', function() {
        it('should call getMemberships successfully', function(done) {
          ...
          instance.getMemberships(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AsanaPreview.MembershipResponseArray);
      ...
      describe('updateMembership', function() {
        it('should call updateMembership successfully', function(done) {
          // TODO: uncomment, update parameter values for updateMembership call and complete the assertions
          /*
          var opts = {};

          instance.updateMembership(membership_gid, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
