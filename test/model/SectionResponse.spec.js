...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.SectionResponse();
  });
  ...
  describe('SectionResponse', function() {
    it('should create an instance of SectionResponse', function() {
      // uncomment below and update the code to test SectionResponse
      //var instance = new AsanaPreview.SectionResponse();
      //expect(instance).to.be.a(AsanaPreview.SectionResponse);
    });
