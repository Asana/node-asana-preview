...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectResponse', function() {
      beforeEach(function() {
        instance = new AsanaPreview.ProjectResponse();
      });

      it('should create an instance of ProjectResponse', function() {
        // TODO: update the code to test ProjectResponse
        expect(instance).to.be.a(AsanaPreview.ProjectResponse);
      });
      ...
      it('should have the property project_brief (base name: "project_brief")', function() {
        // TODO: update the code to test the property project_brief
        expect(instance).to.have.property('project_brief');
        // expect(instance.project_brief).to.be(expectedValueLiteral);
      });

      it('should have the property created_from_template (base name: "created_from_template")', function() {
        // TODO: update the code to test the property created_from_template
        expect(instance).to.have.property('created_from_template');
        // expect(instance.created_from_template).to.be(expectedValueLiteral);
      });
