...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PortfolioResponseCustomFields', function() {
      beforeEach(function() {
        instance = new AsanaPreview.PortfolioResponseCustomFields();
      });

      it('should create an instance of PortfolioResponseCustomFields', function() {
        // TODO: update the code to test PortfolioResponseCustomFields
        expect(instance).to.be.a(AsanaPreview.PortfolioResponseCustomFields);
      });
