...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.GoalRelationshipRequest();
  });
  ...
  describe('GoalRelationshipRequest', function() {
    it('should create an instance of GoalRelationshipRequest', function() {
      ...
      //var instance = new AsanaPreview.GoalRelationshipRequest();
      //expect(instance).to.be.a(AsanaPreview.GoalRelationshipRequest);
    });
