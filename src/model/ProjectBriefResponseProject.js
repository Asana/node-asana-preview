...
class ProjectBriefResponseProject {
    /**
     * Constructs a new <code>ProjectBriefResponseProject</code>.
     ...
     * @alias module:model/ProjectBriefResponseProject
     */
    constructor() { 
        
        ProjectBriefResponseProject.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ProjectBriefResponseProject</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ProjectBriefResponseProject} obj Optional instance to populate.
     * @return {module:model/ProjectBriefResponseProject} The populated <code>ProjectBriefResponseProject</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectBriefResponseProject();
...
export default ProjectBriefResponseProject;
