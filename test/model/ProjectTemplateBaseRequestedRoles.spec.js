...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProjectTemplateBaseRequestedRoles', function() {
      beforeEach(function() {
        instance = new AsanaPreview.ProjectTemplateBaseRequestedRoles();
      });

      it('should create an instance of ProjectTemplateBaseRequestedRoles', function() {
        // TODO: update the code to test ProjectTemplateBaseRequestedRoles
        expect(instance).to.be.a(AsanaPreview.ProjectTemplateBaseRequestedRoles);
      });
