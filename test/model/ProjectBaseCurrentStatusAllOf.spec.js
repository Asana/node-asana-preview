...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.ProjectBaseCurrentStatusAllOf();
  });
  ...
  describe('ProjectBaseCurrentStatusAllOf', function() {
    it('should create an instance of ProjectBaseCurrentStatusAllOf', function() {
      // uncomment below and update the code to test ProjectBaseCurrentStatusAllOf
      //var instance = new AsanaPreview.ProjectBaseCurrentStatusAllOf();
      //expect(instance).to.be.a(AsanaPreview.ProjectBaseCurrentStatusAllOf);
    });
