...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.CustomFieldRequest();
  });
  ...
  describe('CustomFieldRequest', function() {
    it('should create an instance of CustomFieldRequest', function() {
      // uncomment below and update the code to test CustomFieldRequest
      //var instance = new AsanaPreview.CustomFieldRequest();
      //expect(instance).to.be.a(AsanaPreview.CustomFieldRequest);
    });
    ...
    it('should have the property ownedByApp (base name: "owned_by_app")', function() {
      // uncomment below and update the code to test the property ownedByApp
      //var instance = new AsanaPreview.CustomFieldRequest();
      //expect(instance).to.be();
    });
