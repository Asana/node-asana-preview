...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.SectionRequest();
  });
  ...
  describe('SectionRequest', function() {
    it('should create an instance of SectionRequest', function() {
      // uncomment below and update the code to test SectionRequest
      //var instance = new AsanaPreview.SectionRequest();
      //expect(instance).to.be.a(AsanaPreview.SectionRequest);
    });
