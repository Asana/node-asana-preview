...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AsanaPreview.PortfolioMembershipBase();
  });
  ...
  describe('PortfolioMembershipBase', function() {
    it('should create an instance of PortfolioMembershipBase', function() {
      // uncomment below and update the code to test PortfolioMembershipBase
      //var instance = new AsanaPreview.PortfolioMembershipBase();
      //expect(instance).to.be.a(AsanaPreview.PortfolioMembershipBase);
    });
